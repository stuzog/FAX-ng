...
* Tap *Replace Pod* BEFORE disconnecting your RileyLink
	- *Settings > OmniPod* screen
	  - (Also available from *Pump/Pod icon* in top Header in both Loop and FAX-ng)
* Turn RileyLink switch OFF
	- RileyLink *Green LED* will turn off
* Close the Loop/FAX-ng App
	- *Swipe Up* Loop/FAX-ng icon on *Home Screen* 
