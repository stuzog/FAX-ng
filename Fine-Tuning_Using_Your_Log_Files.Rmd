...
Here’s a much easier way for non-technical people:
...
Search for either “is limited” or “is not limited” to get the numbers for both. If the ```[“limited”]/[“is not limited”] x 100``` is less than 5 (5%), then don’t change anything.
...
If everything else is set up correctly for you, these SMB maximums won’t be needed in the future. But now you can know for sure that they are based on the results returned in your log files.
